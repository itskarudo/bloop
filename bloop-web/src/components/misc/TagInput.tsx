...
export const tagInputVariants = cva("border rounded-md flex flex-wrap gap-2", {
  variants: {
    inputFieldPostion: {
...
const TagInput = React.forwardRef<HTMLInputElement, TagInputProps>(
  (props, _) => {
    ...
    if (
      ...
      toast.message("maxTags and minTags cannot be less than 0", {
        description:
    ...
    const handleKeyDown = (e: React.KeyboardEvent<HTMLInputElement>) => {
      if (
        ...
        if (minLength && newTagText.length < minLength) {
          ...
          toast.message("Tag is too short", {
